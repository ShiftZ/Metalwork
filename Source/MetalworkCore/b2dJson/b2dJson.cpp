    ...
    case e_distanceJoint:
        {
            ...
            floatToJson("frequency", distanceJoint->GetStiffness(), jointValue);
            floatToJson("dampingRatio", distanceJoint->GetDamping(), jointValue);
        }
        break;
    case e_pulleyJoint:
        {
    ...
    case e_mouseJoint:
        {
            ...
            floatToJson("frequency", mouseJoint->GetStiffness(), jointValue);
    ...
    case e_wheelJoint:
        {
            ...
            floatToJson("springFrequency", wheelJoint->GetStiffness(), jointValue);
            floatToJson("springDampingRatio", wheelJoint->GetDamping(), jointValue);
        }
        break;
    case e_motorJoint:
        {
    ...
    case e_weldJoint:
        {
            ...
            floatToJson("frequency", weldJoint->GetStiffness(), jointValue);
            floatToJson("dampingRatio", weldJoint->GetDamping(), jointValue);
        }
        break;
...
b2Body* b2dJson::j2b2Body(b2World* world, Json::Value &bodyValue)
{
    ...
    bodyDef.enabled = bodyValue.get("active",true).asBool();
...
b2Joint* b2dJson::j2b2Joint(b2World* world, Json::Value &jointValue)
{
    ...
    else if ( type == "distance" )
    {
        ...
        distanceDef.stiffness = jsonToFloat("frequency", jointValue);
        distanceDef.damping = jsonToFloat("dampingRatio", jointValue);
    }
    else if ( type == "pulley" )
    {
        jointDef = &pulleyDef;
    ...
    else if ( type == "mouse" )
    {
        ...
        mouseDef.stiffness = jsonToFloat("frequency", jointValue);
        mouseDef.damping = jsonToFloat("dampingRatio", jointValue);
    }
    else if ( type == "gear" )
    {
        jointDef = &gearDef;
    ...
    else if ( type == "wheel" )
    {
        ...
        wheelDef.stiffness = jsonToFloat("springFrequency", jointValue);
        wheelDef.damping = jsonToFloat("springDampingRatio", jointValue);
    }
    else if ( type == "motor" )
    {
        jointDef = &motorDef;
    ...
    else if ( type == "weld" )
    {
        ...
        weldDef.stiffness = jsonToFloat("frequency", jointValue);
        weldDef.damping = jsonToFloat("dampingRatio", jointValue);
    }
...
{
    return std::format("{:x}", std::bit_cast<int32_t>(f));
}
